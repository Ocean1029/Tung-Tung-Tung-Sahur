...
class RunCityBadgeDetailView extends GetView<RunCityBadgeDetailController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          controller.badgePoints.isEmpty
              ? _buildEmptyState()
...
class _BadgeHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final canShare = badge.isCompleted;
                    ...
                    child: Center(
                      child: RepaintBoundary(
                        ...
                        child: RunCityBadgeShareCard(
                          badgeName: controller.badge.name,
                          badgeDescription: controller.badgeDescription,
                          collectedPoints: controller.badge.collectedPoints,
                          totalPoints: controller.badge.totalPoints,
                          userName: controller.shareUserName,
                          completedAt: DateTime.now(),
                          badgeColor: TPColors.orange500,
                        ),
                      ),
                    ),
                  ),
